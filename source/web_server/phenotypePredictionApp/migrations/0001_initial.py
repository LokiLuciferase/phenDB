...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='job',
            fields=[
                ('job_id', models.TextField(default=uuid.UUID('a4e5e1c7-3c9e-4ccb-832e-deb8d0877e3c'), primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.TextField(default=uuid.UUID('4b0158c6-ce6e-4cdb-b2a9-9a61cac715a1'))),
