# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-08 20:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='job',
            fields=[
                ('job_id', models.TextField(default=uuid.UUID('f276794f-eedf-4fe9-8bd7-f5f818087d36'), primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.TextField(default=uuid.UUID('be32fbaa-1d65-4e34-8df3-63834d36ab96'))),
        ...
        migrations.AddIndex(
            model_name='model',
            index=models.Index(fields=['model_id'], name='phenotypePr_model_i_f68252_idx'),
        ),
        migrations.AddIndex(
            model_name='job',
