# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-20 00:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='job',
            fields=[
                ('job_name', models.TextField(default=uuid.UUID('dc7c3604-e149-441f-a5f1-f7fba5543c0f'), primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document', models.FileField(upload_to="resultFiles/<class 'django.db.models.fields.TextField'>tar.gz")),
            ],
        ),
        migrations.CreateModel(
            name='UploadedFile',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.TextField(default=uuid.UUID('f41bc162-e625-4918-ba9c-d5ad4f896d1b'))),
