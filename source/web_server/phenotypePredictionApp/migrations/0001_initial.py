# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-14 16:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='job',
            fields=[
                ('job_id', models.TextField(default=uuid.UUID('335ea15a-2859-42ce-9500-d21e4a9d5e13'), primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.TextField(default=uuid.UUID('45e93c52-1b19-410f-bece-86912c51afb0'))),
                ('filename', models.TextField()),
                ('fileInput', models.FileField(upload_to=phenotypePredictionApp.models.upload_function)),
            ],
        ),
        migrations.AddIndex(
            model_name='model',
