...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='job',
            fields=[
                ('job_name', models.TextField(default=uuid.UUID('244c1682-9403-4fcc-878a-5055f5abe9f7'), primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(upload_to='resultFiles/<django.db.models.fields.TextField>tar.gz')),
            ],
        ),
        migrations.CreateModel(
            name='UploadedFile',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.TextField(default=uuid.UUID('42312bca-e2fc-48aa-8206-3ec9b343beae'))),
